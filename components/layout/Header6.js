...
export default function Header6({ scroll, isSearch, handleSearch, isMobileMenu, handleMobileMenu }) {
    return (
        <>
            <header className={`main-header header-style-six ${isSearch ? "moblie-search-active" : ""}`}>
                        ...
                        <div className="inner-container">
                            <ul className="header-contact-list">
                                <li className="contact-info">
                                    ...
                                    <span className="title">Requesting A Call:</span>
                                    <div className="text"><Link href="tel:+92880098670">(629) 555-0129</Link></div>
                                </li>
                                <li className="contact-info">
                                    <span className="icon fa fa-clock"></span>
                                    <span className="title">Sunday - Friday:</span>
                                    <div className="text">9 am - 8 pm</div>
                                </li>
                                <li className="contact-info">
                                    <i className="icon fa fa-map-marker-alt"></i>
                                    <span className="title">6391 Elgin St. Celina, Delaware 10299</span>
                    ...
                    <div className="auto-container">
                        <div className="main-box">
                            <div className="logo-box">
                                <div className="logo"><Link href="/"><img src="images/logo-4.png" alt="" title="Digicod"/></Link></div>
                            </div>
                            ...
                            <div className="outer-box">
                                <button className="ui-btn ui-btn toggle-hidden-bar" onClick={handleMobileMenu}><span className="fa fa-bars"></span></button>
