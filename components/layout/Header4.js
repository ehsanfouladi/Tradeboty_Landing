                    ...
                    <div className="inner-container">
                        <div className="top-left">
                            <ul className="list-style-one light">
                                <li><i className="fa fa-phone"></i> <Link href="tel:6295550129">(629) 555-0129</Link></li>
                                <li><i className="fa fa-envelope"></i> <Link href="mailto:info@example.com">info@example.com</Link></li>
                                <li><i className="fa fa-map-marker-alt"></i> 6391 Elgin St. Celina, 10299</li>
                                <li><i className="fa fa-clock"></i> Sunday - Friday: 9 am - 8 pm</li>
                            </ul>
                        </div>
                ...
                <div className="header-lower">
                    <div className="main-box">
                        <div className="logo-box">
                            <div className="logo"><Link href="index.html"><img src="images/logo-3.png" alt="" title="Digicod"/></Link></div>
                        </div>
