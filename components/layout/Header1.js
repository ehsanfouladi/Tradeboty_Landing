                ...
                <div className="header-lower">
                    <div className="main-box">
                        <div className="logo-box">
                            <div className="logo"><Link href="/"><img src="images/logo.png" alt="" title="Digicod"/></Link></div>
                        </div>
                        ...
                        <div className="btn-box">
                            <Link href="page-contact.html" className="theme-btn btn-style-one"><span className="btn-title">Get a quote <i className="fa fa-arrow-right"></i></span></Link>
                        </div>
                    </div>
                </div>
                {/* Mobile Menu  */}
